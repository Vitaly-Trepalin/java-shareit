...
public class UserControllerTest {
    ...
    private final UserDto userDto1 = new UserDto(id1, name1, email1);

    private final long id2 = 2L;
    private final String name2 = "Maksim";
    private final String email2 = "ya2@ya.ru";
    private final UserDto userDto2 = new UserDto(id2, name2, email2);
    ...
    void testCreateUser() throws Exception {
        UserDto requestUser = new UserDto(id1, name1, email1);
        UserDto expectedUser = new UserDto(id1, name1, email1);
    ...
    void testUpdateUser() throws Exception {
        UserDto requestUser = new UserDto(null, name2, email2);
        UserDto expectedUser = new UserDto(1L, name2, email2);
