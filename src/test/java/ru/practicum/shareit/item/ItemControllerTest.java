...
//    private final ItemCreateDto itemDto1 = new ItemCreateDto(id1, name1, description1, available1, null);
//
//    private final long id2 = 2L;
//    private final String name2 = "item2";
//    private final String description2 = "description2";
//    private final boolean available2 = true;
//    private final ItemCreateDto itemDto2 = new ItemCreateDto(id2, name2, description2, available2, null);
//
//    @Test
...
//        List<ItemCreateDto> items = List.of(itemDto1, itemDto2);
//
...
//        ItemCreateDto expectedItem = new ItemCreateDto(id1, name1, description1, available1, null);
//
...
//        ItemCreateDto requestItem = new ItemCreateDto(id2, name2, description2, available2, null);
//        ItemCreateDto expectedItem = new ItemCreateDto(id1, name2, description2, available2, null);
//
